...
```python
with cui.Container(id="example", width=100, height=100):
```
...
```python
with cui.Container(id="example", padding=10, margin=10):
```
...
```python
with cui.Container(id="example", position=cui.ABSOLUTE, x=10, y=10):
```
...
```python
with cui.Container(id="example", position=cui.ABSOLUTE):
```
...
```python
with cui.Container(id="example", align=cui.ALIGN_START, justify=cui.JUSTIFY_END):
```
