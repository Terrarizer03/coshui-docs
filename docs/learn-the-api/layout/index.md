...
```python
cui.Container(id="example_container", padding=10, margin=10)
```
...
```python
cui.Container(id="example_container", position=cui.ABSOLUTE, x=10, y=10)
```
...
```python
cui.Container(id="example_container", position=cui.ABSOLUTE)
```
...
```python
cui.Container(id="example_container", align=cui.ALIGN_START, justify=cui.JUSTIFY_END)
```
